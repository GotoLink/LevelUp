...
public class GuiClasses extends GuiScreen {
	private final static String toolTips[] = { "", "Miner: +10 Mining, +5 Digging, +5 Smelting | Extra XP from mining", "Warrior: +10 Melee, +5 Defense, +5 Marksman | Extra XP from combat",
		"Artisan: +10 Smelting, +5 Woodcutting, +5 Cooking | Extra XP from crafting", "Spelunker: +10 Defense, +5 Athletics, +5 Mining | Extra XP from mining",
		"Scout: +10 Marksman, +5 Stealth, +5 Athletics | Extra XP from combat", "Farmer: +10 Farming, +5 Fishing, +5 Woodcutting | Extra XP from crafting",
		"Archeologist: +10 Digging, +5 Mining, +5 Woodcutting | Extra XP from mining", "Assassin: +10 Stealth, +5 Melee, +5 Marksman | Extra XP from combat",
		"Lumberjack: +10 Woodcutting, +5 Defense, +5 Athletics | Extra XP from crafting", "Hermit: +10 Cooking, +5 Mining, +5 Digging | Extra XP from mining",
		"Zealot: +10 Athletics, +5 Melee, +5 Defense | Extra XP from combat", "Fisherman: +10 Fishing, +5 Cooking, +5 Woodcutting | Extra XP from crafting",
	"Freelancer: +20 Skill Points | No Extra XP" };
	public final static String classList[] = { "<None>", "Miner", "Warrior", "Artisan", "Spelunker", "Scout", "Farmer", "Archeologist", "Assassin", "Lumberjack", "Hermit", "Zealot", "Fisherman",
	"Freelancer" };
